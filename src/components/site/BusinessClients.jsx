            ...
            <Reveal delay={0.2}>
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-md bg-electric px-7 py-4 text-base font-semibold text-white shadow-lg shadow-electric/30 hover:bg-electric/90 transition-all"
                >
                  Geschäftskunde werden
                </button>
                <button
                  onClick={() => scrollTo("#kontakt")}
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-white/20 px-7 py-4 text-base font-semibold text-white hover:bg-white/10 transition-all"
                >
