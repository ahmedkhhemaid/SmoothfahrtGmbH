        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <Reveal className="order-2 lg:order-1">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-electric px-7 py-4 text-base font-semibold text-white shadow-lg shadow-electric/20 hover:bg-electric/90 transition-all"
            >
