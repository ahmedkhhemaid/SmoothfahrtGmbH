  ...
  return (
    <footer className="bg-carbon text-white border-t border-white/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-10 lg:grid-cols-4 text-center items-start">
          <div className="lg:col-span-1 flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-white/50 max-w-xs mx-auto">
          ...
          <div className="text-center">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li>
                <a href={`tel:${company.phoneHref}`} className="inline-flex items-center gap-3 text-white/60 hover:text-electric transition-colors justify-center">
                  <Phone className="h-4 w-4" /> {company.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${company.email}`} className="inline-flex items-center gap-3 text-white/60 hover:text-electric transition-colors break-all justify-center">
                  <Mail className="h-4 w-4 shrink-0" /> {company.email}
                </a>
              </li>
              <li className="inline-flex items-start gap-3 text-white/60 justify-center text-center">
        ...
        <div className="mt-14 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-center gap-4 text-sm text-white/40 text-center">
  ...
  return (
    <div className="text-center">
      ...
      <ul className="mt-5 space-y-3 text-sm">
        {links.map((l) => (
          <li key={l.label}>
            <button onClick={() => go(l.href)} className="text-white/60 hover:text-electric transition-colors text-center w-full">
              {l.label}
            </button>
          </li>
        ))}
