              ...
              <form onSubmit={submit} className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="sm:col-span-2">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center gap-2 rounded-full bg-electric px-7 py-4 text-base font-semibold text-white shadow-lg shadow-electric/30 hover:bg-electric/90 transition-all disabled:opacity-60"
                  >
