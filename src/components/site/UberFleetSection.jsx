...
export default function UberFleetSection() {
  ...
  return (
    <section id="uber-flotte" className="py-24 lg:py-32 bg-concrete">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <Reveal>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 hidden sm:block rounded-2xl bg-carbon p-6 shadow-xl max-w-[220px]">
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <ul className="mt-8 grid sm:grid-cols-2 gap-3">
                {highlights.map((h) => (
                  <li key={h} className="flex items-center gap-3 text-carbon/80">
            ...
            <Reveal delay={0.2}>
              <div className="mt-10 grid sm:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-steel bg-white p-6">
                  <Car className="h-7 w-7 text-electric" />
                  <h3 className="mt-4 font-heading text-lg font-semibold text-carbon">Für Fahrgäste & Geschäftspartner</h3>
                  <p className="mt-2 text-sm text-carbon/60">
                    Professionelle Personenbeförderung und Mobilitätslösungen.
                  </p>
                  <button
                    onClick={() => scrollTo("#kontakt")}
                    className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-electric hover:text-carbon transition-colors"
                  >
                ...
                <div className="rounded-2xl border border-steel bg-white p-6">
                  ...
                  <h3 className="mt-4 font-heading text-lg font-semibold text-carbon">Für Fahrer</h3>
                  <p className="mt-2 text-sm text-carbon/60">
